...
///
/// You are given a string `answerKey`, where `answerKey[i]` is the original answer to the `iᵗʰ` question. In addition, you are given an integer `k`, the maximum number of times you may perform the following operation:
///
...
/// **Difficulty:** Medium
///
/// **Topics:** Staff, String, Binary Search, Sliding Window, Prefix Sum, Biweekly Contest 62
///
/// - Precondition:
///   - `n == answerKey.length`
///   - `1 <= n <= 5 * 10⁴`
...
///   - `1 <= k <= n`
///
/// - SeeAlso: [2024. Maximize the Confusion of an Exam](https://leetcode.com/problems/maximize-the-confusion-of-an-exam/)
public enum P2024 {
