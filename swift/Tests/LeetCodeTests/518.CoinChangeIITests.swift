...
struct P0518Tests {
    ...
    func example1() {
        ...
        #expect(P0518.changeTabulation(5, [1, 2, 5]) == 4)
    }
    ...
    func example2() {
        ...
        #expect(P0518.changeTabulation(3, [2]) == 0)
    }
    ...
    func example3() {
        ...
        #expect(P0518.changeTabulation(10, [10]) == 1)
    }
    ...
    func zeroAmountWithCoins() {
        ...
        #expect(P0518.changeTabulation(0, [5]) == 1)
    }
    ...
    func firstCoinGreaterThanAmount() {
        ...
        #expect(P0518.changeTabulation(3, [5]) == 0)
    }
    
    @Test("Tabulation handles large input without stack overflow",
          .disabled("Integer overflow in Debug (no overflow checks in Release)"))
    func tabulationLargeInput() {
        ...
        #expect(P0518.changeTabulation(4681, coins) == 0)
    }
}
